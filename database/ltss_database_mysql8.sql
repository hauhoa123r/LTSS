...
DELETE FROM quiz_media;
DELETE FROM review_media;
DELETE FROM tour_media;
DELETE FROM promotion_media;
DELETE FROM business_post_media;
...
DELETE FROM relic_details;
DELETE FROM places;
DELETE FROM place_categories;
DELETE FROM prohibited_terms;
