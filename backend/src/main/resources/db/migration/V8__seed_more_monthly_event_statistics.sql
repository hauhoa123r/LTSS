...
SET NAMES utf8mb4;
=======
ALTER DATABASE ltss CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
>>>>>>> Stashed changes
...
SET @uc58_extra_month_start = CAST(DATE_FORMAT(CURRENT_DATE, '%Y-%m-01') AS DATE);
SET @uc58_extra_month_end = CAST(LAST_DAY(CURRENT_DATE) AS DATE);
...
<<<<<<< Updated upstream
        LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 1 DAY), CAST(@uc58_extra_month_end AS DATE)) AS start_day,
        LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 3 DAY), CAST(@uc58_extra_month_end AS DATE)) AS end_day,
=======
        FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 1 DAY)), TO_DAYS(@uc58_extra_month_end))) AS start_day,
        FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 3 DAY)), TO_DAYS(@uc58_extra_month_end))) AS end_day,
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 4 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 4 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 4 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 4 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 6 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 6 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 6 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 6 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 8 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 8 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 8 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 8 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 11 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 11 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 11 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 11 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 13 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 13 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 13 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 13 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 15 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 15 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 15 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 15 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 19 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 19 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 19 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 19 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 21 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 21 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 21 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 21 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 23 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 23 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 23 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 23 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 25 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 25 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 25 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 25 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 27 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 27 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 27 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 27 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 29 DAY), CAST(@uc58_extra_month_end AS DATE)),
           LEAST(DATE_ADD(CAST(@uc58_extra_month_start AS DATE), INTERVAL 29 DAY), CAST(@uc58_extra_month_end AS DATE)),
=======
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 29 DAY)), TO_DAYS(@uc58_extra_month_end))),
           FROM_DAYS(LEAST(TO_DAYS(DATE_ADD(@uc58_extra_month_start, INTERVAL 29 DAY)), TO_DAYS(@uc58_extra_month_end))),
>>>>>>> Stashed changes
